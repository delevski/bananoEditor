...
const App: React.FC = () => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      console.error(e);
      let friendlyMessage = 'An unexpected error occurred while generating the image.';
      if (e instanceof Error) {
        if (e.message.toLowerCase().includes('api key')) {
           friendlyMessage = 'There seems to be an issue with the API key. Please ensure it is configured correctly in your environment variables and has the necessary permissions.';
        } else {
